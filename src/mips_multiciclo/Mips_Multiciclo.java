        ...
        do {
            ...
            switch (opt) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s0, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s1, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s2, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s3, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s4, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s5, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s6, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s7, $zero, 0"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s0, $zero, 1116"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("BNE $s0, $zero, 2"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("JAL 12"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s1, $zero, 1000"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("J 20"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s6, $s2, 2"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s1, $s1, 3"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s2, $s2, 5"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s3, $s3, 9"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s4, $s4, 14"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s5, $s1, 23"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("JR $ra"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("ADDI $s6, $s2, 3700"));
                    PC.Contador++;
                    Memoria_instrucoes.setMemoria(PC.Contador, Memoria_instrucoes.decode("SLL $s6, $s6, 2"));
                    PC.Contador++;
                    break;
                case 0:
                    System.out.println("\n\nEncerrando programa ............\n\n");
